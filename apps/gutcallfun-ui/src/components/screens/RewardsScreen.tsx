  ...
  return (
    ...
    >
      ...
      <div style={{ flex: 1, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", textAlign: "center", gap: 16, paddingBottom: 20 }}>
        ...
        <div style={{ marginTop: 4, display: "flex", alignItems: "center", gap: 8, background: "rgba(255,216,77,.12)", border: "1px solid rgba(255,216,77,.35)", borderRadius: 999, padding: "7px 14px" }}><span style={{ fontFamily: "'Barlow Condensed',sans-serif", fontStyle: "italic", fontWeight: 700, fontSize: 14, color: "#FFD84D" }}>640</span><span style={{ fontSize: 11, fontWeight: 600, color: "rgba(255,216,77,.7)" }}>points banked</span></div>
      </div>
    </div>
  );
}
