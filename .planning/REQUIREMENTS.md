...
- [ ] **DATA-02**: Env-validated config module (class-validator + `plainToInstance`/`validateSync`, `@Global()` AppConfig) following the hydration-data-feeds pattern; app refuses to boot on invalid env
